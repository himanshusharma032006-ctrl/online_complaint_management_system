      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            View and update complaints allocated to you.
          </p>
        </div>
        ...
        <EmptyState
          ...
          description={
            filters.search || filters.status || filters.priority || filters.category
              ? 'Try clearing some filters to find matching complaints.'
              : 'There are no complaints currently assigned to you.'
          }
        />
      ) : (
        <div className="space-y-6">
          {viewMode === 'grid' ? (
            ...
            <ComplaintTable complaints={data.complaints} role="staff" />
          )}
